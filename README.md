...
Find the best model with Hydra multi-run
```bash
mlflow run . \
   -P steps=train_random_forest \
...
Run the release tagged 1.0.0 from this repository
```bash
mlflow run https://github.com/marcusholmgren/short-time-rental-workflow.git \
             -v 1.0.0 \
             -P hydra_options="etl.sample='sample2.csv'"
```
